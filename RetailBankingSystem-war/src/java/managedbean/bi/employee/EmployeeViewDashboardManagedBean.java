...
public class EmployeeViewDashboardManagedBean {
    ...
    private LineChartModel initAcqAttModel() {
        ...
        acquisition.setLabel("Acquisition Rate Excluding Inactive Bank Account");
        ...
        attrition.setLabel("Attrition Rate Excluding Inactive Bank Account");
    ...
    private BarChartModel initBarModel() {
        ...
        closeAccount.setLabel("Number of Closing Accounts Exclude Inactive Bank Account");
        
        ChartSeries closeInactiveAccount = new ChartSeries();
        closeInactiveAccount.setLabel("Number of Closing Accounts Include Inactive Bank Account");
        ...
        for (i = 0; i < numOfExistingCustomers.size(); i++) {
            ...
            String numOfClosingInactiveAccounts = numOfExistingCustomers.get(i).getNumOfClosingInactiveAccounts();
            String date = updateYear + "." + updateMonth;
            
            openAccount.set(date, Integer.valueOf(numOfOpeningAccounts));
            closeAccount.set(date, Integer.valueOf(numOfClosingAccounts));
            closeInactiveAccount.set(date, Integer.valueOf(numOfClosingInactiveAccounts));
        ...
        model.addSeries(closeInactiveAccount);
