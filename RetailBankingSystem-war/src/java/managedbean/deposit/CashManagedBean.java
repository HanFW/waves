        ...
        if (passwordCheck.equals("Password is incorrect!")) {
            ...
            if (bankAccount.getBankAccountStatus().equals("Activated")) {
                ...
                if (activationCheck.equals("Initial deposit amount is insufficient.")) {
                    ...
                    ec.redirect(ec.getRequestContextPath() + "/web/internalSystem/deposit/customerDepositDone.xhtml?faces-redirect=true");
                }
            }
    ...
    public void cashWithdraw() throws IOException {
        ...
        if (passwordCheck.equals("Password is incorrect!")) {
            ...
            if (diffAmt >= 0) {
                ...
                ec.redirect(ec.getRequestContextPath() + "/web/internalSystem/deposit/customerWithdrawDone.xhtml?faces-redirect=true");
            } else {
