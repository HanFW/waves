...
@Named(value = "employeeBeforeCashDepositManagedBean")
@RequestScoped

public class EmployeeBeforeCashDepositManagedBean {
    ...
    public EmployeeBeforeCashDepositManagedBean() {
    }
    ...
    public void submit() throws IOException {
        ...
        if (customerBasic.getCustomerBasicId() == null) {
            ...
            if (!name.toUpperCase().equals(customerName.toUpperCase())) {
                ...
                ec.redirect(ec.getRequestContextPath() + "/web/internalSystem/deposit/employeeCashDeposit.xhtml?faces-redirect=true");
            }
        }
    }
}
