 ...
 * @author hanfengwei
 */
@Named(value = "customerRepaymentDoneManagedBean")
@RequestScoped
public class customerRepaymentDoneManagedBean {
    ...
    /**
     * Creates a new instance of customerRepaymentDoneManagedBean
     */
    public customerRepaymentDoneManagedBean() {
    }
