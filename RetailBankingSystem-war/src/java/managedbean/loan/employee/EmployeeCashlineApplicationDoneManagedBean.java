 ...
 * @author hanfengwei
 */
@Named(value = "employeeCashlineApplicationDoneManagedBean")
@RequestScoped
public class EmployeeCashlineApplicationDoneManagedBean {
    private String loanType;
    private Integer loanAmount;
    /**
     * Creates a new instance of PublicCashlineApplicationDoneManagedBean
     */
    public EmployeeCashlineApplicationDoneManagedBean() {
    }
