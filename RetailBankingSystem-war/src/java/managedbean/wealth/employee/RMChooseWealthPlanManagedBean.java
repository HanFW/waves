 ...
 * @author Jingyuan
 */
@Named(value = "rMChooseWealthPlanManagedBean")
@RequestScoped
public class RMChooseWealthPlanManagedBean {

    /**
     * Creates a new instance of RMChooseWealthPlanManagedBean
     */
    @EJB
    ...
    public RMChooseWealthPlanManagedBean() {
    }
    ...
    public void submit() throws IOException {
        System.out.println("=");
        System.out.println("====== card/EmployeeRenewCardManagedBean: submit() ======");
        ...
        if (customerBasic.getCustomerBasicId() == null) {
            ...
            if (!name.toUpperCase().equals(customerName.toUpperCase())) {
                ...
                ec.redirect(ec.getRequestContextPath() + "/web/internalSystem/wealth/wealthPlansInfo.xhtml?faces-redirect=true");
            }
        }
    }
