 ...
 * @author Jingyuan
 */
@Named(value = "employeeDeclareFinancialGoalDoneManagedBean")
@ViewScoped
public class EmployeeDeclareFinancialGoalDoneManagedBean implements Serializable{

    /**
     * Creates a new instance of EmployeeDeclareFinancialGoalDoneManagedBean
     */
    @EJB
    ...
    public EmployeeDeclareFinancialGoalDoneManagedBean() {
    }
