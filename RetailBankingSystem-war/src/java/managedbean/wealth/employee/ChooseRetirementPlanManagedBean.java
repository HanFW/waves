...
public class ChooseRetirementPlanManagedBean {
    ...
    public void chooseWealthPlan(ActionEvent event) {
        ...
        if (contributeDuration < 10) {
            ...
            createFinancialGoalSessionBeanLocal.createPortfolio(id, startingBalance, monthlyContribution, contributeDuration, worthYear, amountExpected, "retirement plan");
