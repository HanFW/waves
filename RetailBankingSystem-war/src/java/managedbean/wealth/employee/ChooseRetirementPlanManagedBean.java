 ...
 * @author Jingyuan
 */
@Named(value = "chooseRetirementPlanManagedBean")
@RequestScoped
public class ChooseRetirementPlanManagedBean {

    /**
     * Creates a new instance of ChooseRetirementPlanManagedBean
     */
    @EJB
    ...
    public ChooseRetirementPlanManagedBean() {
    }
    ...
    public void chooseWealthPlan(ActionEvent event) {
        ...
        if (contributeDuration < 10) {
            message = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Contribute duration for retirement plan must be over 10 years", null);
            ...
            createFinancialGoalSessionBeanLocal.createPortfolio(id, startingBalance, monthlyContribution, contributeDuration, worthYear, amountExpected, "retirement plan",rate);
