...
public class EmployeeCancelCardManagedBean{
    ...
    public EmployeeCancelCardManagedBean() {
    }
    ...
    public void submit() throws IOException {
        System.out.println("=");
        System.out.println("====== card/EmployeeCancelCardManagedBean: submit() ======");
        ...
        if (customerBasic.getCustomerBasicId() == null) {
            ...
            if (!name.toUpperCase().equals(customerName.toUpperCase())) {
                ...
                ec.redirect(ec.getRequestContextPath() + "/web/internalSystem/card/employeeCancelCard.xhtml?faces-redirect=true");
            }
        }
    }
