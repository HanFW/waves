 ...
 * @author Nicole
 */
@Named(value = "employeeRenewCardManagedBean")
@RequestScoped
public class EmployeeRenewCardManagedBean {
    ...
    public EmployeeRenewCardManagedBean() {
    }
    ...
    public void submit() throws IOException {
        ...
        if (customerBasic.getCustomerBasicId() == null) {
            ...
            if (!name.toUpperCase().equals(customerName.toUpperCase())) {
                ...
                ec.redirect(ec.getRequestContextPath() + "/web/internalSystem/card/employeeRenewCard.xhtml?faces-redirect=true");
            }
        }
    }
