...
@Named(value = "employeeDeleteStandingGIRODoneManagedBean")
@RequestScoped

public class EmployeeDeleteStandingGIRODoneManagedBean {
    ...
    public EmployeeDeleteStandingGIRODoneManagedBean() {
    }
