...
@Named(value = "employeeNonStandingGIROTransferFinalManagedBean")
@SessionScoped

public class EmployeeNonStandingGIROTransferFinalManagedBean implements Serializable {
    ...
    public EmployeeNonStandingGIROTransferFinalManagedBean() {
    }
    ...
    public void nonStandingGIROTransfer() throws IOException {
        ...
        if (nonStandingGiro.getNonStandingStatus().equals("Approved")) {
            ...
            if (bankName.equals("DBS") && nonStandingGiro.getPaymentFrequency().equals("One Time")) {
                ...
                ec.redirect(ec.getRequestContextPath() + "/web/internalSystem/payment/employeeNonStandingGIROTransferFinished.xhtml?faces-redirect=true");
