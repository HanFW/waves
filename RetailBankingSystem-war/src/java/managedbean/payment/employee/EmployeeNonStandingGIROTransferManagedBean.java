...
@Named(value = "employeeNonStandingGIROTransferManagedBean")
@RequestScoped

public class EmployeeNonStandingGIROTransferManagedBean {
    ...
    public EmployeeNonStandingGIROTransferManagedBean() {
    }
    ...
    public void submit() throws IOException {
        ...
        if (customerBasic.getCustomerBasicId() == null) {
            ...
            if (!name.toUpperCase().equals(customerName.toUpperCase())) {
                ...
                ec.redirect(ec.getRequestContextPath() + "/web/internalSystem/deposit/employeeNonStandingGIROTransferDone.xhtml?faces-redirect=true");
            }
        }
    }
