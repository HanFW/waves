...
@Named(value = "employeeViewRegularGIROTransfer")
@RequestScoped

public class EmployeeViewRegularGIROTransfer {
    ...
    public EmployeeViewRegularGIROTransfer() {
    }
    ...
    public void submit() throws IOException {
        ...
        if (customerBasic.getCustomerBasicId() == null) {
            ...
            if (!name.toUpperCase().equals(customerName.toUpperCase())) {
                ...
                ec.redirect(ec.getRequestContextPath() + "/web/internalSystem/payment/employeeViewRegularGIROTransferDone.xhtml?faces-redirect=true");
            }
        }
    }
}
