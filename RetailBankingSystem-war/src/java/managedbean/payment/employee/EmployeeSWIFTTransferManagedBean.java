...
@Named(value = "employeeSWIFTTransferManagedBean")
@RequestScoped

public class EmployeeSWIFTTransferManagedBean {
    ...
    public EmployeeSWIFTTransferManagedBean() {
    }
    ...
    public void submit() throws IOException {
        ...
        if (customerBasic.getCustomerBasicId() == null) {
            ...
            if (!name.toUpperCase().equals(customerName.toUpperCase())) {
                ...
                ec.redirect(ec.getRequestContextPath() + "/web/internalSystem/payment/employeeSWIFTTransferDone.xhtml?faces-redirect=true");
            }
        }
    }
}
