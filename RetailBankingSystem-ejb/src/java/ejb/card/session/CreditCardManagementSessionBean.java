...
import static ejb.card.entity.DebitCard_.debitCardType;
...
//    @Override
//    public String reportCreditCardLoss(String creditCardNum, String debitCardPassword, String reportLossTime) {
//
//        if (getCardByCardNum(debitCardNum) == null) {
//            return "debit card not exist";
//        } else {
